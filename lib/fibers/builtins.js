				...
				var _qsort = _streamline.async(function _$$_qsort$$(_, beg, end) {
					{
						...
						while (nbeg <= nend) {
							while (nbeg < end && _streamline.await(_filename, 312, null, compare, 0, null, false, [true, array[nbeg], o]) < 0) {
								nbeg++;
							}while (beg < nend && _streamline.await(_filename, 313, null, compare, 0, null, false, [true, o, array[nend]]) < 0) {
								nend--;
							}if (nbeg <= nend) {
									tmp = array[nbeg];
