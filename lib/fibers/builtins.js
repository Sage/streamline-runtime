		...
		value: _streamline.async(function _$$value$$2(_, options, fn, thisObj) {
			{
				...
				if (par === 1 || len <= 1) {
						...
						for (i = 0; i < len; i++) {
							if (has.call(this, i)) result[i] = _streamline.await(_filename, 187, result, i, 0, null, false, [true]);
						}
					}
				return result;
			}
		...
		value: _streamline.async(function _$$value$$3(_, options, fn, thisObj) {
			{
				...
				if (par === 1 || len <= 1) {
						for (var i = 0; i < len; i++) {
							if (has.call(this, i)) {
									var elt = this[i];
									if (_streamline.await(_filename, 214, fn, "call", 1, null, false, [thisObj, true, elt, i, this])) result.push(elt);
								}
						}
					} else {
						_streamline.await(_filename, 218, this, "map_", 0, null, false, [true, par, _streamline.async(function _$$$$3(_, elt, i, arr) {
							{
								if (_streamline.await(_filename, 219, fn, "call", 1, null, false, [thisObj, true, elt, i, arr])) result.push(elt);
							}
						}, 0, 4), thisObj]);
					}
				return result;
		...
		value: _streamline.async(function _$$value$$4(_, options, fn, thisObj) {
			{
				...
				if (par === 1 || len <= 1) {
						for (i = 0; i < len; i++) {
							...
							if (has.call(this, i) && !_streamline.await(_filename, 244, fn, "call", 1, null, false, [thisObj, true, this[i], i, this])) return false;
						}
					} else {
						var fun = funnel(par);
						...
						for (i = 0; i < len; i++) {
							if (has.call(this, i) && !_streamline.await(_filename, 254, futures, i, 0, null, false, [true])) {
									fun.close();
									return false;
								}
						}
		...
		value: _streamline.async(function _$$value$$5(_, options, fn, thisObj) {
			{
				...
				if (par === 1 || len <= 1) {
						for (i = 0; i < len; i++) {
							if (has.call(this, i) && _streamline.await(_filename, 281, fn, "call", 1, null, false, [thisObj, true, this[i], i, this])) return true;
						}
					} else {
						var fun = funnel(par);
						var futures = this.map(function (elt, i, arr) {
						...
						for (i = 0; i < len; i++) {
							if (has.call(this, i) && _streamline.await(_filename, 291, futures, i, 0, null, false, [true])) {
									fun.close();
									return true;
								}
						}
		...
		value: _streamline.async(function _$$value$$6(_, fn, v, thisObj) {
			{
				...
				var len = this.length;
				for (var i = 0; i < len; i++) {
					if (has.call(this, i)) v = _streamline.await(_filename, 311, fn, "call", 1, null, false, [thisObj, true, v, this[i], i, this]);
				}
				return v;
			}
		}, 0, 4)
		...
		value: _streamline.async(function _$$value$$7(_, fn, v, thisObj) {
			{
				...
				for (var i = len - 1; i >= 0; i--) {
					if (has.call(this, i)) v = _streamline.await(_filename, 327, fn, "call", 1, null, false, [thisObj, true, v, this[i], i, this]);
				}
				return v;
			}
		}, 0, 4)
				...
				var _qsort = _streamline.async(function _$$_qsort$$(_, beg, end) {
					{
						...
						var tmp;
						if (end === beg + 1) {
								if (_streamline.await(_filename, 351, null, compare, 0, null, false, [true, array[beg], array[end]]) > 0) {
										tmp = array[beg];
										array[beg] = array[end];
										array[end] = tmp;
									}
						...
						while (nbeg <= nend) {
							while (nbeg < end && _streamline.await(_filename, 365, null, compare, 0, null, false, [true, array[nbeg], o]) < 0) {
								nbeg++;
							}while (beg < nend && _streamline.await(_filename, 366, null, compare, 0, null, false, [true, o, array[nend]]) < 0) {
								nend--;
							}if (nbeg <= nend) {
									tmp = array[nbeg];
