var _streamline = require("streamline-runtime/lib/runtime-fibers");

var _filename = "builtins._js";

require("streamline-runtime/lib/builtins-fibers");
		...
		value: _streamline.async(function _$$value$$(_, options, fn, thisObj) {
			{
				...
				if (par === 1 || len <= 1) {
						for (var i = 0; i < len; i++) {
							if (has.call(this, i)) _streamline.await(_filename, 137, fn, "call", 1, null, false)(thisObj, true, this[i], i, this);
						}
					} else {
						_streamline.await(_filename, 140, this, "map_", 0, null, false)(true, par, fn, thisObj);
					}
				return this;
			}
		}, 0, 4)
		...
		value: _streamline.async(function _$$value$$2(_, options, fn, thisObj) {
			{
				...
				if (par === 1 || len <= 1) {
						...
						for (i = 0; i < len; i++) {
							if (has.call(this, i)) result[i] = _streamline.await(_filename, 166, fn, "call", 1, null, false)(thisObj, true, this[i], i, this);
						}
					} else {
						var fun = funnel(par);
						...
						for (i = 0; i < len; i++) {
							if (has.call(this, i)) result[i] = _streamline.await(_filename, 176, result, i, 0, null, false)(true);
						}
					}
				return result;
			}
		...
		value: _streamline.async(function _$$value$$3(_, options, fn, thisObj) {
			{
				...
				if (par === 1 || len <= 1) {
						for (var i = 0; i < len; i++) {
							if (has.call(this, i)) {
									var elt = this[i];
									if (_streamline.await(_filename, 203, fn, "call", 1, null, false)(thisObj, true, elt, i, this)) result.push(elt);
								}
						}
					} else {
						_streamline.await(_filename, 207, this, "map_", 0, null, false)(true, par, _streamline.async(function _$$$$2(_, elt, i, arr) {
							{
		...
		value: _streamline.async(function _$$value$$4(_, options, fn, thisObj) {
			{
				...
				if (par === 1 || len <= 1) {
						for (i = 0; i < len; i++) {
							...
							if (has.call(this, i) && !_streamline.await(_filename, 233, fn, "call", 1, null, false)(thisObj, true, this[i], i, this)) return false;
						}
					} else {
						var fun = funnel(par);
						...
						for (i = 0; i < len; i++) {
							if (has.call(this, i) && !_streamline.await(_filename, 243, futures, i, 0, null, false)(true)) {
									fun.close();
									return false;
								}
						}
		...
		value: _streamline.async(function _$$value$$5(_, options, fn, thisObj) {
			{
				...
				if (par === 1 || len <= 1) {
						for (i = 0; i < len; i++) {
							if (has.call(this, i) && _streamline.await(_filename, 270, fn, "call", 1, null, false)(thisObj, true, this[i], i, this)) return true;
						}
					} else {
						var fun = funnel(par);
						var futures = this.map(function (elt, i, arr) {
						...
						for (i = 0; i < len; i++) {
							if (has.call(this, i) && _streamline.await(_filename, 280, futures, i, 0, null, false)(true)) {
									fun.close();
									return true;
								}
						}
		...
		value: _streamline.async(function _$$value$$6(_, fn, v, thisObj) {
			{
				...
				var len = this.length;
				for (var i = 0; i < len; i++) {
					if (has.call(this, i)) v = _streamline.await(_filename, 300, fn, "call", 1, null, false)(thisObj, true, v, this[i], i, this);
				}
				return v;
			}
		}, 0, 4)
		...
		value: _streamline.async(function _$$value$$7(_, fn, v, thisObj) {
			{
				...
				for (var i = len - 1; i >= 0; i--) {
					if (has.call(this, i)) v = _streamline.await(_filename, 316, fn, "call", 1, null, false)(thisObj, true, v, this[i], i, this);
				}
				return v;
			}
		}, 0, 4)
		...
		value: _streamline.async(function _$$value$$8(_, compare, beg, end) {
			{
				var _qsort = _streamline.async(function _$$_qsort$$(_, beg, end) {
					{
						...
						var tmp;
						if (end === beg + 1) {
								if (_streamline.await(_filename, 340, null, compare, 0, null, false)(true, array[beg], array[end]) > 0) {
										tmp = array[beg];
										array[beg] = array[end];
										array[end] = tmp;
									}
						...
						while (nbeg <= nend) {
							while (nbeg < end && _streamline.await(_filename, 354, null, compare, 0, null, false)(true, array[nbeg], o) < 0) nbeg++;
							while (beg < nend && _streamline.await(_filename, 355, null, compare, 0, null, false)(true, o, array[nend]) < 0) nend--;
						...
						if (nbeg < end) _streamline.await(_filename, 366, null, _qsort, 0, null, false)(true, nbeg, end);
						if (beg < nend) _streamline.await(_filename, 367, null, _qsort, 0, null, false)(true, beg, nend);
					}
				}, 0, 3);
				...
				_streamline.await(_filename, 369, null, _qsort, 0, null, false)(true, beg, end);
				return array;
			}
		}, 0, 4)
	});
