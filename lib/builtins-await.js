...
require("streamline-runtime/lib/builtins-await");
		...
		value: _streamline.async(async function _$$value$$(_, options, fn, thisObj) {
			{
				...
				if (par === 1 || len <= 1) {
						for (var i = 0; i < len; i++) {
							if (has.call(this, i)) await _streamline.await(_filename, 137, fn, "call", 1, null, false)(thisObj, true, this[i], i, this);
						}
					} else {
						await _streamline.await(_filename, 140, this, "map_", 0, null, false)(true, par, fn, thisObj);
					}
				return this;
			}
		}, 0, 4)
		...
		value: _streamline.async(async function _$$value$$2(_, options, fn, thisObj) {
			{
				...
				if (par === 1 || len <= 1) {
						...
						for (i = 0; i < len; i++) {
							if (has.call(this, i)) result[i] = await _streamline.await(_filename, 166, fn, "call", 1, null, false)(thisObj, true, this[i], i, this);
						}
					} else {
						var fun = funnel(par);
						result = this.map(function (elt, i, arr) {
							return _streamline.future(_filename, 171, null, fun, 0, null, false)(false, _streamline.async(async function _$$$$(_) {
								{
									return await _streamline.await(_filename, null, fn, "call", 1, null, false)(thisObj, true, elt, i, arr);
								}
							}, 0, 1));
						});
						for (i = 0; i < len; i++) {
							if (has.call(this, i)) result[i] = await _streamline.await(_filename, 176, result, i, 0, null, false)(true);
						}
					}
				return result;
			}
		...
		value: _streamline.async(async function _$$value$$3(_, options, fn, thisObj) {
			{
				...
				if (par === 1 || len <= 1) {
						for (var i = 0; i < len; i++) {
							if (has.call(this, i)) {
									var elt = this[i];
									if (await _streamline.await(_filename, 203, fn, "call", 1, null, false)(thisObj, true, elt, i, this)) result.push(elt);
								}
						}
					} else {
						await _streamline.await(_filename, 207, this, "map_", 0, null, false)(true, par, _streamline.async(async function _$$$$2(_, elt, i, arr) {
							{
								if (await _streamline.await(_filename, null, fn, "call", 1, null, false)(thisObj, true, elt, i, arr)) result.push(elt);
							}
						}, 0, 4), thisObj);
					}
				return result;
		...
		value: _streamline.async(async function _$$value$$4(_, options, fn, thisObj) {
			{
				...
				if (par === 1 || len <= 1) {
						for (i = 0; i < len; i++) {
							...
							if (has.call(this, i) && !await _streamline.await(_filename, 233, fn, "call", 1, null, false)(thisObj, true, this[i], i, this)) return false;
						}
					} else {
						var fun = funnel(par);
						var futures = this.map(function (elt, i, arr) {
							return _streamline.future(_filename, 238, null, fun, 0, null, false)(false, _streamline.async(async function _$$$$3(_) {
								{
									return await _streamline.await(_filename, null, fn, "call", 1, null, false)(thisObj, true, elt, i, arr);
								}
							}, 0, 1));
						...
						for (i = 0; i < len; i++) {
							if (has.call(this, i) && !await _streamline.await(_filename, 243, futures, i, 0, null, false)(true)) {
									fun.close();
									return false;
								}
						}
		...
		value: _streamline.async(async function _$$value$$5(_, options, fn, thisObj) {
			{
				...
				if (par === 1 || len <= 1) {
						for (i = 0; i < len; i++) {
							if (has.call(this, i) && await _streamline.await(_filename, 270, fn, "call", 1, null, false)(thisObj, true, this[i], i, this)) return true;
						}
					} else {
						var fun = funnel(par);
						var futures = this.map(function (elt, i, arr) {
							return _streamline.future(_filename, 275, null, fun, 0, null, false)(false, _streamline.async(async function _$$$$4(_) {
								{
									return await _streamline.await(_filename, null, fn, "call", 1, null, false)(thisObj, true, elt, i, arr);
								}
							}, 0, 1));
						...
						for (i = 0; i < len; i++) {
							if (has.call(this, i) && await _streamline.await(_filename, 280, futures, i, 0, null, false)(true)) {
									fun.close();
									return true;
								}
						}
		...
		value: _streamline.async(async function _$$value$$6(_, fn, v, thisObj) {
			{
				...
				var len = this.length;
				for (var i = 0; i < len; i++) {
					if (has.call(this, i)) v = await _streamline.await(_filename, 300, fn, "call", 1, null, false)(thisObj, true, v, this[i], i, this);
				}
				return v;
			}
		}, 0, 4)
		...
		value: _streamline.async(async function _$$value$$7(_, fn, v, thisObj) {
			{
				...
				for (var i = len - 1; i >= 0; i--) {
					if (has.call(this, i)) v = await _streamline.await(_filename, 316, fn, "call", 1, null, false)(thisObj, true, v, this[i], i, this);
				}
				return v;
			}
		}, 0, 4)
		...
		value: _streamline.async(async function _$$value$$8(_, compare, beg, end) {
			{
				var _qsort = _streamline.async(async function _$$_qsort$$(_, beg, end) {
					{
						...
						var tmp;
						if (end === beg + 1) {
								if (await _streamline.await(_filename, 340, null, compare, 0, null, false)(true, array[beg], array[end]) > 0) {
										tmp = array[beg];
										array[beg] = array[end];
										array[end] = tmp;
									}
						...
						while (nbeg <= nend) {
							while (nbeg < end && await _streamline.await(_filename, 354, null, compare, 0, null, false)(true, array[nbeg], o) < 0) nbeg++;
							while (beg < nend && await _streamline.await(_filename, 355, null, compare, 0, null, false)(true, o, array[nend]) < 0) nend--;
						...
						if (nbeg < end) await _streamline.await(_filename, 366, null, _qsort, 0, null, false)(true, nbeg, end);
						if (beg < nend) await _streamline.await(_filename, 367, null, _qsort, 0, null, false)(true, beg, nend);
					}
				}, 0, 3);
				...
				await _streamline.await(_filename, 369, null, _qsort, 0, null, false)(true, beg, end);
				return array;
			}
		}, 0, 4)
	});
