var _streamline = typeof require === "function" ? require("streamline-runtime/lib/runtime-await") : Streamline.require("streamline-runtime/lib/runtime-await");

var _filename = "builtins._js";
typeof require === "function" ? require("streamline-runtime/lib/builtins-await") : Streamline.require("streamline-runtime/lib/builtins-await");
/**
				...
				var _qsort = _streamline.async(async function _$$_qsort$$(_, beg, end) {
					{
						...
						while (nbeg <= nend) {
							while (nbeg < end && await _streamline.await(_filename, 312, null, compare, 0, null, false)(true, array[nbeg], o) < 0) nbeg++;
							while (beg < nend && await _streamline.await(_filename, 313, null, compare, 0, null, false)(true, o, array[nend]) < 0) nend--;
