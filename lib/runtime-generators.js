...
var starTemplate = function(fn, options) {
		...
		var F = function *() {
				if (idx < 0) Array.prototype.splice.call(arguments, idx, 0, null);
...
var unstarTemplate = function(fn, options) {
		...
		var F = function F() {
				...
				if (typeof cb !== "function") {
					if (cb == null) cb = util.defaultCallback;
					else if (cb === false) return exports.future("", 0, null, F.bind(self), idx)(arguments);
