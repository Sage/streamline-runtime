		...
		var fun = _streamline.async(async function _$$$$(_2, fn) {
			{
				...
				if (max < 0 || max === Infinity) return await _streamline.await(_filename, 64, null, fn, 0, null, false, [true]);
				// optimization to avoid _ -> callback transition in fibers mode when the funnel is available.
				if (active < max) {
						active++;
						try {
							return await _streamline.await(_filename, 69, null, fn, 0, null, false, [true]);
						} finally {
							active--;
							while (active < max && queue.length > 0) {
								_doOne();
						...
						return await _streamline.await(_filename, 75, null, overflow, 0, null, false, [true, fn]);
					}
			}
		}, 0, 2);
		...
		value: _streamline.async(async function _$$value$$(_3, options, fn, thisObj) {
			{
				...
				if (par === 1 || len <= 1) {
						for (var i = 0; i < len; i++) {
							if (has.call(this, i)) await _streamline.await(_filename, 148, fn, "call", 1, null, false, [thisObj, true, this[i], i, this]);
						}
					} else {
						await _streamline.await(_filename, 151, this, "map_", 0, null, false, [true, par, fn, thisObj]);
					}
				return this;
			}
		}, 0, 4)
		...
		value: _streamline.async(async function _$$value$$2(_4, options, fn, thisObj) {
			{
				...
				if (par === 1 || len <= 1) {
						...
						for (i = 0; i < len; i++) {
							if (has.call(this, i)) result[i] = await _streamline.await(_filename, 177, fn, "call", 1, null, false, [thisObj, true, this[i], i, this]);
						}
					} else {
						var fun = funnel(par);
						result = this.map(function (elt, i, arr) {
							return _streamline.future(_filename, 182, null, fun, 0, null, false, [false, _streamline.async(async function _$$$$2(_5) {
								{
									return await _streamline.await(_filename, 183, fn, "call", 1, null, false, [thisObj, true, elt, i, arr]);
								}
							}, 0, 1)]);
						});
						for (i = 0; i < len; i++) {
							if (has.call(this, i)) result[i] = await _streamline.await(_filename, 187, result, i, 0, null, false, [true]);
						}
					}
				return result;
			}
		...
		value: _streamline.async(async function _$$value$$3(_6, options, fn, thisObj) {
			{
				...
				if (par === 1 || len <= 1) {
						for (var i = 0; i < len; i++) {
							if (has.call(this, i)) {
									var elt = this[i];
									if (await _streamline.await(_filename, 214, fn, "call", 1, null, false, [thisObj, true, elt, i, this])) result.push(elt);
								}
						}
					} else {
						await _streamline.await(_filename, 218, this, "map_", 0, null, false, [true, par, _streamline.async(async function _$$$$3(_7, elt, i, arr) {
							{
								if (await _streamline.await(_filename, 219, fn, "call", 1, null, false, [thisObj, true, elt, i, arr])) result.push(elt);
							}
						}, 0, 4), thisObj]);
					}
				return result;
		...
		value: _streamline.async(async function _$$value$$4(_8, options, fn, thisObj) {
			{
				...
				if (par === 1 || len <= 1) {
						for (i = 0; i < len; i++) {
							...
							if (has.call(this, i) && !(await _streamline.await(_filename, 244, fn, "call", 1, null, false, [thisObj, true, this[i], i, this]))) return false;
						}
					} else {
						var fun = funnel(par);
						var futures = this.map(function (elt, i, arr) {
							return _streamline.future(_filename, 249, null, fun, 0, null, false, [false, _streamline.async(async function _$$$$4(_9) {
								{
									return await _streamline.await(_filename, 250, fn, "call", 1, null, false, [thisObj, true, elt, i, arr]);
								}
							}, 0, 1)]);
						});
						for (i = 0; i < len; i++) {
							if (has.call(this, i) && !(await _streamline.await(_filename, 254, futures, i, 0, null, false, [true]))) {
									fun.close();
									return false;
								}
						}
		...
		value: _streamline.async(async function _$$value$$5(_10, options, fn, thisObj) {
			{
				...
				if (par === 1 || len <= 1) {
						for (i = 0; i < len; i++) {
							if (has.call(this, i) && (await _streamline.await(_filename, 281, fn, "call", 1, null, false, [thisObj, true, this[i], i, this]))) return true;
						}
					} else {
						var fun = funnel(par);
						var futures = this.map(function (elt, i, arr) {
							return _streamline.future(_filename, 286, null, fun, 0, null, false, [false, _streamline.async(async function _$$$$5(_11) {
								{
									return await _streamline.await(_filename, 287, fn, "call", 1, null, false, [thisObj, true, elt, i, arr]);
								}
							}, 0, 1)]);
						});
						for (i = 0; i < len; i++) {
							if (has.call(this, i) && (await _streamline.await(_filename, 291, futures, i, 0, null, false, [true]))) {
									fun.close();
									return true;
								}
						}
		...
		value: _streamline.async(async function _$$value$$6(_12, fn, v, thisObj) {
			{
				...
				var len = this.length;
				for (var i = 0; i < len; i++) {
					if (has.call(this, i)) v = await _streamline.await(_filename, 311, fn, "call", 1, null, false, [thisObj, true, v, this[i], i, this]);
				}
				return v;
			}
		}, 0, 4)
		...
		value: _streamline.async(async function _$$value$$7(_13, fn, v, thisObj) {
			{
				...
				for (var i = len - 1; i >= 0; i--) {
					if (has.call(this, i)) v = await _streamline.await(_filename, 327, fn, "call", 1, null, false, [thisObj, true, v, this[i], i, this]);
				}
				return v;
			}
		}, 0, 4)
		...
		value: _streamline.async(async function _$$value$$8(_14, compare, beg, end) {
			{
				var _qsort = _streamline.async(async function _$$_qsort$$(_15, beg, end) {
					{
						...
						var tmp;
						if (end === beg + 1) {
								if ((await _streamline.await(_filename, 351, null, compare, 0, null, false, [true, array[beg], array[end]])) > 0) {
										tmp = array[beg];
										array[beg] = array[end];
										array[end] = tmp;
									}
						...
						while (nbeg <= nend) {
							while (nbeg < end && (await _streamline.await(_filename, 365, null, compare, 0, null, false, [true, array[nbeg], o])) < 0) {
								nbeg++;
							}while (beg < nend && (await _streamline.await(_filename, 366, null, compare, 0, null, false, [true, o, array[nend]])) < 0) {
								nend--;
							}if (nbeg <= nend) {
									tmp = array[nbeg];
						...
						if (nbeg < end) await _streamline.await(_filename, 377, null, _qsort, 0, null, false, [true, nbeg, end]);
						if (beg < nend) await _streamline.await(_filename, 378, null, _qsort, 0, null, false, [true, beg, nend]);
					}
				}, 0, 3);
				...
				await _streamline.await(_filename, 380, null, _qsort, 0, null, false, [true, beg, end]);
				return array;
			}
		}, 0, 4)
	});
