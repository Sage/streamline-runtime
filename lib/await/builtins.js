...
(function (exports) {
	...
	var funnel = function funnel(max, options) {
		...
		var fun = _streamline.async(async function _$$$$(_2, fn) {
			{
				//console.log("FUNNEL: active=" + active + ", queued=" + queue.length);
				if (max < 0 || max === Infinity) return await _streamline.await(_filename, 81, null, fn, 0, null, false, [true]);
				// test reentrancy, only if max is 1
				if (max === 1 && reentering()) {
						if (options.reentrant) return await _streamline.await(_filename, 84, null, fn, 0, null, false, [true]);else throw new Error("funnel is not reentrant");
					}
				...
				if (active < max) {
						...
						context = globals.context;
						try {
							return await _streamline.await(_filename, 92, null, fn, 0, null, false, [true]);
						} finally {
							active--;
							context = undefined;
							while (active < max && queue.length > 0) {
						...
						return await _streamline.await(_filename, 99, null, overflow, 0, null, false, [true, fn]);
					}
			}
		}, 0, 2);
	...
	Object.defineProperty(Array.prototype, 'forEach_', {
		...
		writable: true,
		enumerable: false,
		value: _streamline.async(async function _$$value$$(_3, options, fn, thisObj) {
			{
				...
				if (par === 1 || len <= 1) {
						for (var i = 0; i < len; i++) {
							if (has.call(this, i)) await _streamline.await(_filename, 172, fn, "call", 1, null, false, [thisObj, true, this[i], i, this]);
						}
					} else {
						await _streamline.await(_filename, 175, this, "map_", 0, null, false, [true, par, fn, thisObj]);
					}
				return this;
			}
		}, 0, 4)
	...
	Object.defineProperty(Array.prototype, 'map_', {
		...
		writable: true,
		enumerable: false,
		value: _streamline.async(async function _$$value$$2(_4, options, fn, thisObj) {
			{
				if (typeof options === "function") {
						thisObj = fn;
						fn = options;
				...
				if (par === 1 || len <= 1) {
						...
						for (i = 0; i < len; i++) {
							if (has.call(this, i)) result[i] = await _streamline.await(_filename, 201, fn, "call", 1, null, false, [thisObj, true, this[i], i, this]);
						}
					} else {
						var fun = funnel(par);
						result = this.map(function (elt, i, arr) {
							return _streamline.future(_filename, 206, null, fun, 0, null, false, [false, _streamline.async(async function _$$$$2(_5) {
								{
									return await _streamline.await(_filename, 207, fn, "call", 1, null, false, [thisObj, true, elt, i, arr]);
								}
							}, 0, 1)]);
						});
						for (i = 0; i < len; i++) {
							if (has.call(this, i)) result[i] = await _streamline.await(_filename, 211, result, i, 0, null, false, [true]);
						}
					}
				return result;
			}
	...
	Object.defineProperty(Array.prototype, 'filter_', {
		...
		writable: true,
		enumerable: false,
		value: _streamline.async(async function _$$value$$3(_6, options, fn, thisObj) {
			{
				if (typeof options === "function") {
						thisObj = fn;
						fn = options;
				...
				if (par === 1 || len <= 1) {
						for (var i = 0; i < len; i++) {
							if (has.call(this, i)) {
									var elt = this[i];
									if (await _streamline.await(_filename, 238, fn, "call", 1, null, false, [thisObj, true, elt, i, this])) result.push(elt);
								}
						}
					} else {
						await _streamline.await(_filename, 242, this, "map_", 0, null, false, [true, par, _streamline.async(async function _$$$$3(_7, elt, i, arr) {
							{
								if (await _streamline.await(_filename, 243, fn, "call", 1, null, false, [thisObj, true, elt, i, arr])) result.push(elt);
							}
						}, 0, 4), thisObj]);
					}
				return result;
	...
	Object.defineProperty(Array.prototype, 'every_', {
		...
		writable: true,
		enumerable: false,
		value: _streamline.async(async function _$$value$$4(_8, options, fn, thisObj) {
			{
				if (typeof options === "function") {
						thisObj = fn;
						fn = options;
				...
				if (par === 1 || len <= 1) {
						for (i = 0; i < len; i++) {
							...
							if (has.call(this, i) && !(await _streamline.await(_filename, 268, fn, "call", 1, null, false, [thisObj, true, this[i], i, this]))) return false;
						}
					} else {
						var fun = funnel(par);
						var futures = this.map(function (elt, i, arr) {
							return _streamline.future(_filename, 273, null, fun, 0, null, false, [false, _streamline.async(async function _$$$$4(_9) {
								{
									return await _streamline.await(_filename, 274, fn, "call", 1, null, false, [thisObj, true, elt, i, arr]);
								}
							}, 0, 1)]);
						});
						for (i = 0; i < len; i++) {
							if (has.call(this, i) && !(await _streamline.await(_filename, 278, futures, i, 0, null, false, [true]))) {
									fun.close();
									return false;
								}
						}
	...
	Object.defineProperty(Array.prototype, 'some_', {
		...
		writable: true,
		enumerable: false,
		value: _streamline.async(async function _$$value$$5(_10, options, fn, thisObj) {
			{
				if (typeof options === "function") {
						thisObj = fn;
						fn = options;
				...
				if (par === 1 || len <= 1) {
						for (i = 0; i < len; i++) {
							if (has.call(this, i) && (await _streamline.await(_filename, 305, fn, "call", 1, null, false, [thisObj, true, this[i], i, this]))) return true;
						}
					} else {
						var fun = funnel(par);
						var futures = this.map(function (elt, i, arr) {
							return _streamline.future(_filename, 310, null, fun, 0, null, false, [false, _streamline.async(async function _$$$$5(_11) {
								{
									return await _streamline.await(_filename, 311, fn, "call", 1, null, false, [thisObj, true, elt, i, arr]);
								}
							}, 0, 1)]);
						});
						for (i = 0; i < len; i++) {
							if (has.call(this, i) && (await _streamline.await(_filename, 315, futures, i, 0, null, false, [true]))) {
									fun.close();
									return true;
								}
						}
	...
	Object.defineProperty(Array.prototype, 'reduce_', {
		...
		writable: true,
		enumerable: false,
		value: _streamline.async(async function _$$value$$6(_12, fn, v, thisObj) {
			{
				thisObj = thisObj !== undefined ? thisObj : this;
				var len = this.length;
				for (var i = 0; i < len; i++) {
					if (has.call(this, i)) v = await _streamline.await(_filename, 335, fn, "call", 1, null, false, [thisObj, true, v, this[i], i, this]);
				}
				return v;
			}
		}, 0, 4)
	...
	Object.defineProperty(Array.prototype, 'reduceRight_', {
		...
		writable: true,
		enumerable: false,
		value: _streamline.async(async function _$$value$$7(_13, fn, v, thisObj) {
			{
				thisObj = thisObj !== undefined ? thisObj : this;
				var len = this.length;
				for (var i = len - 1; i >= 0; i--) {
					if (has.call(this, i)) v = await _streamline.await(_filename, 351, fn, "call", 1, null, false, [thisObj, true, v, this[i], i, this]);
				}
				return v;
			}
		}, 0, 4)
	...
	Object.defineProperty(Array.prototype, 'sort_', {
		...
		writable: true,
		enumerable: false,
		value: _streamline.async(async function _$$value$$8(_14, compare, beg, end) {
			{
				var _qsort = _streamline.async(async function _$$_qsort$$(_15, beg, end) {
					{
						if (beg >= end) return;

						var tmp;
						if (end === beg + 1) {
								if ((await _streamline.await(_filename, 375, null, compare, 0, null, false, [true, array[beg], array[end]])) > 0) {
										tmp = array[beg];
										array[beg] = array[end];
										array[end] = tmp;
									}
						...
						while (nbeg <= nend) {
							while (nbeg < end && (await _streamline.await(_filename, 389, null, compare, 0, null, false, [true, array[nbeg], o])) < 0) {
								nbeg++;
							}while (beg < nend && (await _streamline.await(_filename, 390, null, compare, 0, null, false, [true, o, array[nend]])) < 0) {
								nend--;
							}if (nbeg <= nend) {
									tmp = array[nbeg];
						...
						if (nbeg < end) await _streamline.await(_filename, 401, null, _qsort, 0, null, false, [true, nbeg, end]);
						if (beg < nend) await _streamline.await(_filename, 402, null, _qsort, 0, null, false, [true, beg, nend]);
					}
				}, 0, 3);
				...
				await _streamline.await(_filename, 404, null, _qsort, 0, null, false, [true, beg, end]);
				return array;
			}
		}, 0, 4)
	});
