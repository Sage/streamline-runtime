		...
		value: _streamline.async(async function _$$value$$2(_4, options, fn, thisObj) {
...

			{
				...
				if (par === 1 || len <= 1) {
						...
						result = new Array(len);
						for (var j = 0; j < par; j++) {
							futures[j] = _streamline.future(_filename, 183, null, _streamline.async(async function _$$$$2(_5) {
								{
									while (i < _this.length) {
										var k = i++;
										result[k] = await _streamline.await(_filename, 186, fn, "call", 1, null, false, [thisObj, true, _this[k], k, _this]);
									}
								}
							}, 0, 1), 0, null, false, [false]);
						}for (var j = 0; j < par; j++) {
							await _streamline.await(_filename, 189, futures, j, 0, null, false, [true]);
						}
					}
				return result;
			}
		...
		value: _streamline.async(async function _$$value$$3(_6, options, fn, thisObj) {
			{
				...
				if (par === 1 || len <= 1) {
						for (var i = 0; i < len; i++) {
							if (has.call(this, i)) {
									var elt = this[i];
									if (await _streamline.await(_filename, 215, fn, "call", 1, null, false, [thisObj, true, elt, i, this])) result.push(elt);
								}
						}
					} else {
						await _streamline.await(_filename, 219, this, "map_", 0, null, false, [true, par, _streamline.async(async function _$$$$3(_7, elt, i, arr) {
							{
								if (await _streamline.await(_filename, 220, fn, "call", 1, null, false, [thisObj, true, elt, i, arr])) result.push(elt);
							}
						}, 0, 4), thisObj]);
					}
				return result;
		...
		value: _streamline.async(async function _$$value$$4(_8, options, fn, thisObj) {
			{
				...
				if (par === 1 || len <= 1) {
						for (i = 0; i < len; i++) {
							...
							if (has.call(this, i) && !(await _streamline.await(_filename, 245, fn, "call", 1, null, false, [thisObj, true, this[i], i, this]))) return false;
						}
					} else {
						var fun = funnel(par);
						var futures = this.map(function (elt, i, arr) {
							return _streamline.future(_filename, 250, null, fun, 0, null, false, [false, _streamline.async(async function _$$$$4(_9) {
								{
									return await _streamline.await(_filename, 251, fn, "call", 1, null, false, [thisObj, true, elt, i, arr]);
								}
							}, 0, 1)]);
						});
						for (i = 0; i < len; i++) {
							if (has.call(this, i) && !(await _streamline.await(_filename, 255, futures, i, 0, null, false, [true]))) {
									fun.close();
									return false;
								}
						}
		...
		value: _streamline.async(async function _$$value$$5(_10, options, fn, thisObj) {
			{
				...
				if (par === 1 || len <= 1) {
						for (i = 0; i < len; i++) {
							if (has.call(this, i) && (await _streamline.await(_filename, 282, fn, "call", 1, null, false, [thisObj, true, this[i], i, this]))) return true;
						}
					} else {
						var fun = funnel(par);
						var futures = this.map(function (elt, i, arr) {
							return _streamline.future(_filename, 287, null, fun, 0, null, false, [false, _streamline.async(async function _$$$$5(_11) {
								{
									return await _streamline.await(_filename, 288, fn, "call", 1, null, false, [thisObj, true, elt, i, arr]);
								}
							}, 0, 1)]);
						});
						for (i = 0; i < len; i++) {
							if (has.call(this, i) && (await _streamline.await(_filename, 292, futures, i, 0, null, false, [true]))) {
									fun.close();
									return true;
								}
						}
		...
		value: _streamline.async(async function _$$value$$6(_12, fn, v, thisObj) {
			{
				...
				var len = this.length;
				for (var i = 0; i < len; i++) {
					if (has.call(this, i)) v = await _streamline.await(_filename, 312, fn, "call", 1, null, false, [thisObj, true, v, this[i], i, this]);
				}
				return v;
			}
		}, 0, 4)
		...
		value: _streamline.async(async function _$$value$$7(_13, fn, v, thisObj) {
			{
				...
				for (var i = len - 1; i >= 0; i--) {
					if (has.call(this, i)) v = await _streamline.await(_filename, 328, fn, "call", 1, null, false, [thisObj, true, v, this[i], i, this]);
				}
				return v;
			}
		}, 0, 4)
		...
		value: _streamline.async(async function _$$value$$8(_14, compare, beg, end) {
			{
				var _qsort = _streamline.async(async function _$$_qsort$$(_15, beg, end) {
					{
						...
						var tmp;
						if (end === beg + 1) {
								if ((await _streamline.await(_filename, 352, null, compare, 0, null, false, [true, array[beg], array[end]])) > 0) {
										tmp = array[beg];
										array[beg] = array[end];
										array[end] = tmp;
									}
						...
						while (nbeg <= nend) {
							while (nbeg < end && (await _streamline.await(_filename, 366, null, compare, 0, null, false, [true, array[nbeg], o])) < 0) {
								nbeg++;
							}while (beg < nend && (await _streamline.await(_filename, 367, null, compare, 0, null, false, [true, o, array[nend]])) < 0) {
								nend--;
							}if (nbeg <= nend) {
									tmp = array[nbeg];
						...
						if (nbeg < end) await _streamline.await(_filename, 378, null, _qsort, 0, null, false, [true, nbeg, end]);
						if (beg < nend) await _streamline.await(_filename, 379, null, _qsort, 0, null, false, [true, beg, nend]);
					}
				}, 0, 3);
				...
				await _streamline.await(_filename, 381, null, _qsort, 0, null, false, [true, beg, end]);
				return array;
			}
		}, 0, 4)
	});
