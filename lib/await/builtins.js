...
(function (exports) {
	...
	var funnel = function funnel(max) {
		...
		var fun = _streamline.async(async function _$$$$(_, fn) {
			{
		...
		value: _streamline.async(async function _$$value$$2(_, options, fn, thisObj) {
			{
				...
				if (par === 1 || len <= 1) {
						...
						result = this.map(function (elt, i, arr) {
							return _streamline.future(_filename, 182, null, fun, 0, null, false, [false, _streamline.async(async function _$$$$2(_) {
								{
		...
		value: _streamline.async(async function _$$value$$3(_, options, fn, thisObj) {
			{
				...
				if (par === 1 || len <= 1) {
						...
						await _streamline.await(_filename, 218, this, "map_", 0, null, false, [true, par, _streamline.async(async function _$$$$3(_, elt, i, arr) {
							{
		...
		value: _streamline.async(async function _$$value$$4(_, options, fn, thisObj) {
			{
				...
				if (par === 1 || len <= 1) {
						...
						var futures = this.map(function (elt, i, arr) {
							return _streamline.future(_filename, 249, null, fun, 0, null, false, [false, _streamline.async(async function _$$$$4(_) {
								{
		...
		value: _streamline.async(async function _$$value$$5(_, options, fn, thisObj) {
			{
				...
				if (par === 1 || len <= 1) {
						...
						var fun = funnel(par);
						var futures = this.map(function (elt, i, arr) {
							return _streamline.future(_filename, 286, null, fun, 0, null, false, [false, _streamline.async(async function _$$$$5(_) {
								{
