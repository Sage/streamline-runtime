		...
		value: _streamline.async(function* _$$value$$2(_4, options, fn, thisObj) {
			{
				...
				if (par === 1 || len <= 1) {
						...
						result = this.map(function (elt, i, arr) {
							return _streamline.future(_filename, 182, null, fun, 0, null, false, [false, _streamline.async(function* _$$$$2(_5) {
								{
		...
		value: _streamline.async(function* _$$value$$3(_6, options, fn, thisObj) {
			{
				...
				if (par === 1 || len <= 1) {
						...
						yield _streamline.await(_filename, 218, this, "map_", 0, null, false, [true, par, _streamline.async(function* _$$$$3(_7, elt, i, arr) {
							{
		...
		value: _streamline.async(function* _$$value$$4(_8, options, fn, thisObj) {
			{
				...
				if (par === 1 || len <= 1) {
						...
						var futures = this.map(function (elt, i, arr) {
							return _streamline.future(_filename, 249, null, fun, 0, null, false, [false, _streamline.async(function* _$$$$4(_9) {
								{
		...
		value: _streamline.async(function* _$$value$$5(_10, options, fn, thisObj) {
			{
				...
				if (par === 1 || len <= 1) {
						...
						var fun = funnel(par);
						var futures = this.map(function (elt, i, arr) {
							return _streamline.future(_filename, 286, null, fun, 0, null, false, [false, _streamline.async(function* _$$$$5(_11) {
								{
