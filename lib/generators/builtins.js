...
(function (exports) {
	...
	var funnel = function funnel(max) {
		...
		var fun = _streamline.async(function* _$$$$(_, fn) {
			{
		...
		value: _streamline.async(function* _$$value$$2(_, options, fn, thisObj) {
			{
				...
				if (par === 1 || len <= 1) {
						...
						result = this.map(function (elt, i, arr) {
							return _streamline.future(_filename, 182, null, fun, 0, null, false, [false, _streamline.async(function* _$$$$2(_) {
								{
									return yield _streamline.await(_filename, 183, fn, "call", 1, null, false, [thisObj, true, elt, i, arr]);
								}
							}, 0, 1)]);
						});
						for (i = 0; i < len; i++) {
							if (has.call(this, i)) result[i] = yield _streamline.await(_filename, 187, result, i, 0, null, false, [true]);
						}
					}
				return result;
			}
		...
		value: _streamline.async(function* _$$value$$3(_, options, fn, thisObj) {
			{
				...
				if (par === 1 || len <= 1) {
						for (var i = 0; i < len; i++) {
							if (has.call(this, i)) {
									var elt = this[i];
									if (yield _streamline.await(_filename, 214, fn, "call", 1, null, false, [thisObj, true, elt, i, this])) result.push(elt);
								}
						}
					} else {
						yield _streamline.await(_filename, 218, this, "map_", 0, null, false, [true, par, _streamline.async(function* _$$$$3(_, elt, i, arr) {
							{
								if (yield _streamline.await(_filename, 219, fn, "call", 1, null, false, [thisObj, true, elt, i, arr])) result.push(elt);
							}
						}, 0, 4), thisObj]);
					}
				return result;
		...
		value: _streamline.async(function* _$$value$$4(_, options, fn, thisObj) {
			{
				...
				if (par === 1 || len <= 1) {
						for (i = 0; i < len; i++) {
							...
							if (has.call(this, i) && !(yield _streamline.await(_filename, 244, fn, "call", 1, null, false, [thisObj, true, this[i], i, this]))) return false;
						}
					} else {
						var fun = funnel(par);
						var futures = this.map(function (elt, i, arr) {
							return _streamline.future(_filename, 249, null, fun, 0, null, false, [false, _streamline.async(function* _$$$$4(_) {
								{
									return yield _streamline.await(_filename, 250, fn, "call", 1, null, false, [thisObj, true, elt, i, arr]);
								}
							}, 0, 1)]);
						});
						for (i = 0; i < len; i++) {
							if (has.call(this, i) && !(yield _streamline.await(_filename, 254, futures, i, 0, null, false, [true]))) {
									fun.close();
									return false;
								}
						}
		...
		value: _streamline.async(function* _$$value$$5(_, options, fn, thisObj) {
			{
				...
				if (par === 1 || len <= 1) {
						for (i = 0; i < len; i++) {
							if (has.call(this, i) && (yield _streamline.await(_filename, 281, fn, "call", 1, null, false, [thisObj, true, this[i], i, this]))) return true;
						}
					} else {
						var fun = funnel(par);
						var futures = this.map(function (elt, i, arr) {
							return _streamline.future(_filename, 286, null, fun, 0, null, false, [false, _streamline.async(function* _$$$$5(_) {
								{
									return yield _streamline.await(_filename, 287, fn, "call", 1, null, false, [thisObj, true, elt, i, arr]);
								}
							}, 0, 1)]);
						});
						for (i = 0; i < len; i++) {
							if (has.call(this, i) && (yield _streamline.await(_filename, 291, futures, i, 0, null, false, [true]))) {
									fun.close();
									return true;
								}
						}
		...
		value: _streamline.async(function* _$$value$$6(_, fn, v, thisObj) {
			{
				...
				var len = this.length;
				for (var i = 0; i < len; i++) {
					if (has.call(this, i)) v = yield _streamline.await(_filename, 311, fn, "call", 1, null, false, [thisObj, true, v, this[i], i, this]);
				}
				return v;
			}
		}, 0, 4)
		...
		value: _streamline.async(function* _$$value$$7(_, fn, v, thisObj) {
			{
				...
				for (var i = len - 1; i >= 0; i--) {
					if (has.call(this, i)) v = yield _streamline.await(_filename, 327, fn, "call", 1, null, false, [thisObj, true, v, this[i], i, this]);
				}
				return v;
			}
		}, 0, 4)
		...
		value: _streamline.async(function* _$$value$$8(_, compare, beg, end) {
			{
				var _qsort = _streamline.async(function* _$$_qsort$$(_, beg, end) {
					{
						...
						var tmp;
						if (end === beg + 1) {
								if ((yield _streamline.await(_filename, 351, null, compare, 0, null, false, [true, array[beg], array[end]])) > 0) {
										tmp = array[beg];
										array[beg] = array[end];
										array[end] = tmp;
									}
						...
						while (nbeg <= nend) {
							while (nbeg < end && (yield _streamline.await(_filename, 365, null, compare, 0, null, false, [true, array[nbeg], o])) < 0) {
								nbeg++;
							}while (beg < nend && (yield _streamline.await(_filename, 366, null, compare, 0, null, false, [true, o, array[nend]])) < 0) {
								nend--;
							}if (nbeg <= nend) {
									tmp = array[nbeg];
						...
						if (nbeg < end) yield _streamline.await(_filename, 377, null, _qsort, 0, null, false, [true, nbeg, end]);
						if (beg < nend) yield _streamline.await(_filename, 378, null, _qsort, 0, null, false, [true, beg, nend]);
					}
				}, 0, 3);
				...
				yield _streamline.await(_filename, 380, null, _qsort, 0, null, false, [true, beg, end]);
				return array;
			}
		}, 0, 4)
	});
