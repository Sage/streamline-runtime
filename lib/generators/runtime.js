...
function invoke(that, fn, args, index, options) {
...
var starTemplate = function(fn, options) {
		...
		var F = function *() {
				return (yield invoke(this, fn, arguments, index, options));
			};
