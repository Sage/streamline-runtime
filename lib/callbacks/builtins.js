				...
				while (1) {
					switch (_context4.prev = _context4.next) {
						...
						case 17:
							...
							result = new Array(len);
							for (j = 0; j < par; j++) {
								futures[j] = _streamline.future(_filename, 183, null, _streamline.async(regeneratorRuntime.mark(function _$$$$2(_5) {
									var k;
										...
										while (1) {
											switch (_context3.prev = _context3.next) {
												case 0:
													...
													k = i++;
													_context3.next = 4;
													return _streamline.await(_filename, 186, fn, "call", 1, null, false, [thisObj, true, _this[k], k, _this]);
						...
						case 22:
							...
							_context4.next = 25;
							return _streamline.await(_filename, 189, futures, j, 0, null, false, [true]);
				...
				while (1) {
					switch (_context6.prev = _context6.next) {
						...
						case 7:
							...
							elt = this[i];
							_context6.next = 12;
							return _streamline.await(_filename, 215, fn, "call", 1, null, false, [thisObj, true, elt, i, this]);
						...
						case 19:
							_context6.next = 21;
							return _streamline.await(_filename, 219, this, "map_", 0, null, false, [true, par, _streamline.async(regeneratorRuntime.mark(function _$$$$3(_7, elt, i, arr) {
								return regeneratorRuntime.wrap(function _$$$$3$(_context5) {
									while (1) {
										switch (_context5.prev = _context5.next) {
											case 0:
												_context5.next = 2;
												return _streamline.await(_filename, 220, fn, "call", 1, null, false, [thisObj, true, elt, i, arr]);
				...
				while (1) {
					switch (_context8.prev = _context8.next) {
						...
						case 6:
							...
							_context8.next = 11;
							return _streamline.await(_filename, 245, fn, "call", 1, null, false, [thisObj, true, this[i], i, this]);
						...
						case 19:
							...
							futures = this.map(function (elt, i, arr) {
								return _streamline.future(_filename, 250, null, fun, 0, null, false, [false, _streamline.async(regeneratorRuntime.mark(function _$$$$4(_9) {
									return regeneratorRuntime.wrap(function _$$$$4$(_context7) {
										while (1) {
											switch (_context7.prev = _context7.next) {
												case 0:
													_context7.next = 2;
													return _streamline.await(_filename, 251, fn, "call", 1, null, false, [thisObj, true, elt, i, arr]);
						...
						case 22:
							...
							_context8.next = 27;
							return _streamline.await(_filename, 255, futures, i, 0, null, false, [true]);
				...
				while (1) {
					switch (_context10.prev = _context10.next) {
						...
						case 6:
							...
							_context10.next = 11;
							return _streamline.await(_filename, 282, fn, "call", 1, null, false, [thisObj, true, this[i], i, this]);
						...
						case 19:
							fun = funnel(par);
							futures = this.map(function (elt, i, arr) {
								return _streamline.future(_filename, 287, null, fun, 0, null, false, [false, _streamline.async(regeneratorRuntime.mark(function _$$$$5(_11) {
									return regeneratorRuntime.wrap(function _$$$$5$(_context9) {
										while (1) {
											switch (_context9.prev = _context9.next) {
												case 0:
													_context9.next = 2;
													return _streamline.await(_filename, 288, fn, "call", 1, null, false, [thisObj, true, elt, i, arr]);
						...
						case 22:
							...
							_context10.next = 27;
							return _streamline.await(_filename, 292, futures, i, 0, null, false, [true]);
				...
				while (1) {
					switch (_context11.prev = _context11.next) {
						...
						case 3:
							...
							_context11.next = 7;
							return _streamline.await(_filename, 312, fn, "call", 1, null, false, [thisObj, true, v, this[i], i, this]);
				...
				while (1) {
					switch (_context12.prev = _context12.next) {
						...
						case 3:
							...
							_context12.next = 7;
							return _streamline.await(_filename, 328, fn, "call", 1, null, false, [thisObj, true, v, this[i], i, this]);
				...
				while (1) {
					switch (_context14.prev = _context14.next) {
						case 0:
									...
									while (1) {
										switch (_context13.prev = _context13.next) {
											...
											case 2:
												...
												_context13.next = 5;
												return _streamline.await(_filename, 352, null, compare, 0, null, false, [true, array[beg], array[end]]);
											...
											case 16:
												...
												_context13.next = 20;
												return _streamline.await(_filename, 366, null, compare, 0, null, false, [true, array[nbeg], o]);
											...
											case 26:
												...
												_context13.next = 30;
												return _streamline.await(_filename, 367, null, compare, 0, null, false, [true, o, array[nend]]);
											...
											case 39:
												...
												_context13.next = 42;
												return _streamline.await(_filename, 378, null, _qsort, 0, null, false, [true, nbeg, end]);
											...
											case 42:
												...
												_context13.next = 45;
												return _streamline.await(_filename, 379, null, _qsort, 0, null, false, [true, beg, nend]);
							...
							_context14.next = 6;
							return _streamline.await(_filename, 381, null, _qsort, 0, null, false, [true, beg, end]);
