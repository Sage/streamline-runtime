...
(function (exports) {
	...
	var funnel = function funnel(max, options) {
		...
		var fun = _streamline.async(regeneratorRuntime.mark(function _$$$$(_2, fn) {
				...
				while (1) {
					switch (_context.prev = _context.next) {
						case 0:
							...
							_context.next = 3;
							return _streamline.await(_filename, 81, null, fn, 0, null, false, [true]);
						...
						case 4:
							...
							_context.next = 8;
							return _streamline.await(_filename, 84, null, fn, 0, null, false, [true]);

						case 8:
							return _context.abrupt("return", _context.sent);

						case 11:
							throw new Error("funnel is not reentrant");
	...
	Object.defineProperty(Array.prototype, 'forEach_', {
		...
		writable: true,
		enumerable: false,
		value: _streamline.async(regeneratorRuntime.mark(function _$$value$$(_3, options, fn, thisObj) {
			var par, len, i;
				...
				while (1) {
					switch (_context2.prev = _context2.next) {
						...
						case 6:
							...
							_context2.next = 10;
							return _streamline.await(_filename, 172, fn, "call", 1, null, false, [thisObj, true, this[i], i, this]);
						...
						case 15:
							_context2.next = 17;
							return _streamline.await(_filename, 175, this, "map_", 0, null, false, [true, par, fn, thisObj]);
	...
	Object.defineProperty(Array.prototype, 'map_', {
		...
		writable: true,
		enumerable: false,
		value: _streamline.async(regeneratorRuntime.mark(function _$$value$$2(_4, options, fn, thisObj) {
				...
				while (1) {
					switch (_context4.prev = _context4.next) {
						...
						case 7:
							...
							_context4.next = 11;
							return _streamline.await(_filename, 201, fn, "call", 1, null, false, [thisObj, true, this[i], i, this]);
						...
						case 17:
							...
							result = this.map(function (elt, i, arr) {
								return _streamline.future(_filename, 206, null, fun, 0, null, false, [false, _streamline.async(regeneratorRuntime.mark(function _$$$$2(_5) {
						...
						case 20:
							...
							_context4.next = 24;
							return _streamline.await(_filename, 211, result, i, 0, null, false, [true]);
	...
	Object.defineProperty(Array.prototype, 'filter_', {
		...
		writable: true,
		enumerable: false,
		value: _streamline.async(regeneratorRuntime.mark(function _$$value$$3(_6, options, fn, thisObj) {
				...
				while (1) {
					switch (_context6.prev = _context6.next) {
						...
						case 7:
							...
							elt = this[i];
							_context6.next = 12;
							return _streamline.await(_filename, 238, fn, "call", 1, null, false, [thisObj, true, elt, i, this]);
						...
						case 19:
							_context6.next = 21;
							return _streamline.await(_filename, 242, this, "map_", 0, null, false, [true, par, _streamline.async(regeneratorRuntime.mark(function _$$$$3(_7, elt, i, arr) {
								return regeneratorRuntime.wrap(function _$$$$3$(_context5) {
									while (1) {
										switch (_context5.prev = _context5.next) {
											case 0:
												_context5.next = 2;
												return _streamline.await(_filename, 243, fn, "call", 1, null, false, [thisObj, true, elt, i, arr]);
	...
	Object.defineProperty(Array.prototype, 'every_', {
		...
		writable: true,
		enumerable: false,
		value: _streamline.async(regeneratorRuntime.mark(function _$$value$$4(_8, options, fn, thisObj) {
				...
				while (1) {
					switch (_context8.prev = _context8.next) {
						...
						case 6:
							...
							_context8.next = 11;
							return _streamline.await(_filename, 268, fn, "call", 1, null, false, [thisObj, true, this[i], i, this]);
						...
						case 19:
							...
							futures = this.map(function (elt, i, arr) {
								return _streamline.future(_filename, 273, null, fun, 0, null, false, [false, _streamline.async(regeneratorRuntime.mark(function _$$$$4(_9) {
						...
						case 22:
							...
							_context8.next = 27;
							return _streamline.await(_filename, 278, futures, i, 0, null, false, [true]);
	...
	Object.defineProperty(Array.prototype, 'some_', {
		...
		writable: true,
		enumerable: false,
		value: _streamline.async(regeneratorRuntime.mark(function _$$value$$5(_10, options, fn, thisObj) {
			var par, len, i, fun, futures;
				...
				while (1) {
					switch (_context10.prev = _context10.next) {
						...
						case 6:
							...
							_context10.next = 11;
							return _streamline.await(_filename, 305, fn, "call", 1, null, false, [thisObj, true, this[i], i, this]);
						...
						case 19:
							fun = funnel(par);
							futures = this.map(function (elt, i, arr) {
								return _streamline.future(_filename, 310, null, fun, 0, null, false, [false, _streamline.async(regeneratorRuntime.mark(function _$$$$5(_11) {
						...
						case 22:
							...
							_context10.next = 27;
							return _streamline.await(_filename, 315, futures, i, 0, null, false, [true]);
	...
	Object.defineProperty(Array.prototype, 'reduce_', {
		...
		writable: true,
		enumerable: false,
		value: _streamline.async(regeneratorRuntime.mark(function _$$value$$6(_12, fn, v, thisObj) {
			var len, i;
				...
				while (1) {
					switch (_context11.prev = _context11.next) {
						...
						case 3:
							...
							_context11.next = 7;
							return _streamline.await(_filename, 335, fn, "call", 1, null, false, [thisObj, true, v, this[i], i, this]);
	...
	Object.defineProperty(Array.prototype, 'reduceRight_', {
		...
		writable: true,
		enumerable: false,
		value: _streamline.async(regeneratorRuntime.mark(function _$$value$$7(_13, fn, v, thisObj) {
			var len, i;
				...
				while (1) {
					switch (_context12.prev = _context12.next) {
						...
						case 3:
							...
							_context12.next = 7;
							return _streamline.await(_filename, 351, fn, "call", 1, null, false, [thisObj, true, v, this[i], i, this]);
	...
	Object.defineProperty(Array.prototype, 'sort_', {
		...
		writable: true,
		enumerable: false,
		value: _streamline.async(regeneratorRuntime.mark(function _$$value$$8(_14, compare, beg, end) {
			var _qsort, array;
			...
			return regeneratorRuntime.wrap(function _$$value$$8$(_context14) {
				while (1) {
					switch (_context14.prev = _context14.next) {
						case 0:
							_qsort = _streamline.async(regeneratorRuntime.mark(function _$$_qsort$$(_15, beg, end) {
									...
									while (1) {
										switch (_context13.prev = _context13.next) {
											...
											case 2:
												...
												_context13.next = 5;
												return _streamline.await(_filename, 375, null, compare, 0, null, false, [true, array[beg], array[end]]);
											...
											case 16:
												...
												_context13.next = 20;
												return _streamline.await(_filename, 389, null, compare, 0, null, false, [true, array[nbeg], o]);
											...
											case 26:
												...
												_context13.next = 30;
												return _streamline.await(_filename, 390, null, compare, 0, null, false, [true, o, array[nend]]);
											...
											case 39:
												...
												_context13.next = 42;
												return _streamline.await(_filename, 401, null, _qsort, 0, null, false, [true, nbeg, end]);
											...
											case 42:
												...
												_context13.next = 45;
												return _streamline.await(_filename, 402, null, _qsort, 0, null, false, [true, beg, nend]);
							...
							_context14.next = 6;
							return _streamline.await(_filename, 404, null, _qsort, 0, null, false, [true, beg, end]);
